...
sshpass -p ubnt ssh -q ubnt@192.168.1.1 "curl -s -m 5 --head --request GET http://192.168.0.2" > Firewall3_http.txt 
...
if grep -A8 "rule 10" configuration2.txt | grep -A7  "action accept" | grep -q "related enable"; then
